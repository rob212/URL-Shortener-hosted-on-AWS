...
4.  **Set permissions:** Select "Attach policies directly."
    ...
    - *Note: In a production environment, we use "Least Privilege," but for learning CDK, you need high-level access to create Buckets, Lambdas, and IAM Roles.*
5.  Click **Create user**.
...
5.  Check the box "I understand the security recommendation..." and click **Next**.
